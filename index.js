...
function printProductDetails(obj) {
  ...
  console.log(productName, price, companyName, country); // Виводимо productName, price, city та country на консоль
}
...
function addProperty(array) {
  array.customProperty = "myProperty"; // Додаємо нову властивість customProperty до прототипу Array зі значенням myProperty
